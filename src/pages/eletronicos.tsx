...
function CategoriaEletronicos({ produtos }: CategoriaPageProps) {
    const tipoProdutos = ["smartphones", "laptops"]

    const produtosDaCategoria = produtos.filter(
        (produto) => tipoProdutos.includes(produto.category)
    )
    const marcas: string[] = []
        ...
        <main className={styles.main}>
            ...
            <section className={styles.section}>
                <div className={styles.container_produtos}>
                    <FiltroProdutos nome="ELETRÔNICOS"/>
