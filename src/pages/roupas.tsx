...
function CategoriaRoupas({ produtos }: CategoriaPageProps) {
    const tipoProdutos = ["tops", "womens-dresses", "mens-shirts"];
...
export default CategoriaRoupas;
